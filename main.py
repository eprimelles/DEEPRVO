...
from environment.Env_mix import DeepNavMix
...
ENV_Mix = DeepNavMix(N_AGENTS, 2, 0)
EVAL = True
TRAIN = True
ALGORITHMS = {
    ...
    'dqn' : 0, # config DQN,
    'dqn_tf' : [MADQN_TF(2, N_AGENTS * 4 + 2, 9), RB_TF(N_AGENTS * 4 + 2, 2, MAX_LENGTH, BATCH_SIZE)]
}
...
print("OOOO")
if TRAIN:
    program.train(ENV_Mix, rb, N_EPISODES)

if EVAL:
    program.test(ENV_Mix)
